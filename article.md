...
Since the homology groups of $SF(S^2\times S^1, T)$ are just infinite cyclic groups, it turns out that to understand maps from $H_n(SF(S^2\times S^1, T))$, it suffices to only consider the action of the map on the generators.
